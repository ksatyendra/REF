/**6.b) Develop an applet that receives an integer in one text field, and computes its factorial Value and returns it
in another text field, when the button named “Compute” is clicked.*/

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;
/*<applet code="FactorialApplet.class"  height=300 width=300 > </applet>*/
